...
const Round2 = () => {
  ...
  useEffect(() => {
    // Get all Qualifier Round participants
    const qualifierParticipants = roundsData.rounds["Qualifier Round"];

    // Shuffle participants randomly
    const shuffled = [...qualifierParticipants].sort(() => Math.random() - 0.5);

    // Create 12 random pairs (24 participants needed, ensuring even pairing)
    const matchPairs = [];
